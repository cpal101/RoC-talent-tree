...
fontawesome_svg_core_1.library.add(free_solid_svg_icons_1.faBug, free_solid_svg_icons_1.faCodeBranch);
...
TalentsModule = __decorate([
    core_1.NgModule({
        ...
        imports: [
            ...
            angular_fontawesome_1.FontAwesomeModule,
            ngx_popper_1.NgxPopperModule.forRoot({ placement: 'right' }),
